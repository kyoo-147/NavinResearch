...
function content(page, mode) {
  ...
  if (mode === "index") return atlas(page);
...
function routeLead(page, mode) {
  return `<section class="sd-route-lead sd-route-lead--${e(mode)}"><div><span>${e(page.eyebrow || `DEPARTMENT / ${mode.toUpperCase()}`)}</span><h1>${e(page.headline || page.title)}</h1></div><p>${e(page.lede || page.description)}</p><dl><div><dt>OWNER</dt><dd>HUMAN</dd></div><div><dt>STATE</dt><dd>EXPLICIT</dd></div><div><dt>ACTION</dt><dd>REVIEW</dd></div></dl></section>`;
}
